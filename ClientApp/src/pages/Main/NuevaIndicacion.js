...
const NuevaIndicacion = (props) => {
    ...
    function _onSubmit(values) {
      if (component.data) {
        console.log(values)
        API.updateIndicacion(values)
          .then(res => {
            console.log(res.data);
          })
          .catch(err => console.log(err));
      } else {
        API.addIndicacion(values)
          .then(res => {
            setEditable(false);
            values.indicacion.id = res.data.id
            var data = values.indicacion;
            component.onClick("NuevaIndicacion", { data });
            console.log(res.data);
          })
          .catch(err => console.log(err));
      }
            ...
            <Form>
              ...
              <nav class="level">
                ...
                <div class="level-right">
                  ...
                  <p class="level-item"><a class="button is-success" type="submit" onClick={() => { component.onClick("Indicaciones") }}>CERRAR</a></p>
                </div>
              </nav>
                ...
                <div class="level-left">
                  <div class="level-item">
                    <p class="control">
                      ...
                      <Field disabled={component.data && !editable} class="input" type="text" name="indicacion.clave" placeholder="Clave" />
                    </p>
                  </div>
                </div>
              </nav>
                ...
                <div class="level-left">
                  <div class="level-item">
                    <p class="control">
                      ...
                      <Field disabled={component.data && !editable} class="input" type="text" name="indicacion.nombre" placeholder="Nombre" />
                    </p>
                  </div>
                </div>
              </nav>
